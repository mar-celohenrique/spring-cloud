...
public class ConsumerService {
    ...
    public String readingList() {
        return restTemplate.getForObject(URI.create(serviceUrl() + "recommended"), String.class);
    }
    ...
    public String buy() {
        return restTemplate.getForObject(URI.create(serviceUrl() + "buy"), String.class);
    }
